...
while True:
    tipoCam, camara = capturaVideo.read()
    if tipoCam == False:
        break
    ...
    if imagen_A6 is not None:
        ...
        for c_2 in contorno2:
            area = cv2.contourArea(c_2) # Area del objeto contorneado
            ...
            if area < 11000 and area > 9500: # Variación segun el tamaño de la moneda
                font = cv2.FONT_HERSHEY_SIMPLEX
                cv2.putText(imagen_A6, "$1", (x, y),
                            font, 0.75, (0, 0, 255), 2)
                suma1 = suma1 + 1.0

            if area < 9100 and area > 8000:
                font = cv2.FONT_HERSHEY_SIMPLEX
                cv2.putText(imagen_A6, "$2", (x, y),
                            font, 0.75, (0, 0, 255), 2)
                suma2 = suma2 + 2.0
        total = suma1 + suma2
